...
import 'package:nopsuite/Models/CountryStateModel.dart';
...
class GetProductDetailsModel {
  ...
  factory GetProductDetailsModel.fromJson(Map<String, dynamic> json) => GetProductDetailsModel(
    ...
    videoModels: List<VideoModel>.from(json["VideoModels"].map((x) => VideoModel.fromJson(x))),
    name: json["Name"],
    ...
    productTags: List<ProductTags>.from(json["ProductTags"].map((x) => ProductTags.fromJson(x))),
